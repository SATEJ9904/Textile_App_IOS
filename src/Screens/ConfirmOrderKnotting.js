...
const ConfirmOrderKnotting = ({ navigation }) => {
  ...
  const ModalDataFetch = (Id) => {
    ...
    fetch("https://textileapp.microtechsolutions.co.in/php/getbyid.php?Table=KnottingOffer&Colname=KnottingId&Colvalue=" + Id, requestOptions)
      ...
      .catch((error) => {
        console.log("Knotting Error = ",error);
        setLoading(false);
      });
